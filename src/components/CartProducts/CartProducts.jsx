...
const CartProducts = ({ item }) => {
    ...
    return (
        <section className="cart-cards">
            {/* Desktop */}
            <div className="md:flex hidden card-product flex-row justify-around items-center p-6 mb-6 bg-gradient-to-r from-blue-900 to-indigo-800 rounded-lg shadow-lg transform transition-all hover:scale-105 group">
