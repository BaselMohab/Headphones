...
return (
    <section className='arrival mb-20 '>
        ...
        <div className='flex flex-col justify-evenly gap-3 items-center xs:px-3  lg:flex-row lg:px-4 xl:flex-row'>
            ...
            <div className="new-arrival flex flex-col gap-5 text-white items-center">
                <h3 className='uppercase md:text-4xl text-2xl'>Sony WH-1000XM5</h3>
        ...
        <div className='flex flex-col justify-evenly gap-3 items-center xs:px-3 2xs:px-2 lg:flex-row-reverse lg:px-5 xl:flex-row-reverse '>
            <img className='rounded-lg '  src='../assets/images/marshal.jpg' />
            <div className="new-arrival flex flex-col gap-5 text-white items-center">
                <h3 className='uppercase md:text-4xl text-2xl'>marshal  major IV</h3>
                <p className='capitalize md:text-lg text-md text-center px-3'>the iconic headphones from Marshall with 80+ solid hours of wireless playtime, wireless charging and a new.</p>
                <Link to='/products/8' className='arrival-btn'>more details</Link>
            </div>
        </div>
        <div className='flex flex-col justify-evenly gap-3 items-center xs:px-3 2xs:px-2 lg:flex-row lg:px-4 xl:flex-row'>
            <img className='rounded-lg'  src='../assets/images/philips.jpg' />
            <div className="new-arrival flex flex-col gap-5 text-white items-center">
                <h3 className='uppercase md:text-4xl text-2xl'>Philips Bold Bass</h3>
